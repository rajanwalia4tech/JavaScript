...
// console.log(arr.map(x => { if (x == 2) return x; }))
...
Array.prototype.reduceApna = function (cb, intialValue) {
    let res = intialValue;
    console.log(this)
...
// console.log(
//     array.reduceApna((accumulator, currentValue) =>
...
// // using reduce function [2,13,21,5]
// console.log(
